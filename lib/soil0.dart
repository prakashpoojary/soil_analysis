...
class MySoilData0 extends StatefulWidget {
  const MySoilData0({Key? key}) : super(key: key);

  @override
  State<MySoilData0> createState() => _MySoilData0State();
}

class _MySoilData0State extends State<MySoilData0> {
                  ...
                  onPressed: () async {
                    if (values1 != null && values1!.isNotEmpty) {
                      ...
                      if (user != null && user.displayName != null) {
                        ...
                        final dbPath = 'saved_data/$userName/$areaId/$plotId/${DateTime.now().millisecondsSinceEpoch}';
